...
const OfficeGallery: React.FC = () => {
  ...
  const galleryImages = (data.gallery || []).filter((item: any) => item.isActive !== false);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isGalleryEnabled && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[250px] mb-24">
        ...
        {/* ── Team Section Header ── */}
        <div className={`${isGalleryEnabled ? 'mt-32' : 'mt-0'} text-center mb-16`}>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
